    ...
    <div className="flex h-screen flex-col bg-bg font-body text-text">
      ...
      {!kitchenEnabled ? (
        <div className="flex flex-1 items-center justify-center p-6 text-center text-sm text-text-muted">
          Kitchen ordering is turned off for this café. Orders are served directly by staff —
          ask your admin to enable it under Settings → Operations if you need this screen.
        </div>
      ) : (
